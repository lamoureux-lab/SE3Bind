...
Examples:
  ...
  python train_T1.py --mode evaluate --config inference_config.txt --experiment my_experiment --epoch 1000

  # Resume training from checkpoint
  python train_T1.py --mode resume --config configT1.txt --resume-epoch 500
        ''')
